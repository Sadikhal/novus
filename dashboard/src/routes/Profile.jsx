...
//                 <label className='md:flex-[0.9] gap-2 md:gap-0 flex  md:justify-between items-center capitalize font-poppins md:text-base text-sm font-medium text-slate-800'>
//                 seller ID
//                   <span>: </span>
//                 </label>
