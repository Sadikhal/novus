...
function Login() {
  ...
  return (
    ...
    >
      <div className='xl:w-[60%] w-80 sm:w-96 md:w-[60%] xl:h-auto  justify-between items-center h-full flex flex-col-reverse xl:flex-row shadow-2xl xl:mb-0 mt-2 mb-4 xl:mt-0 py-8 xl:py-3 xl:pb-5 bg-lamaWhite'>
