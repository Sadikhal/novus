        ...
        <div className="w-full">
          ...
          <div className="flex flex-col">
            <div className="flex w-full flex-col lg:flex-row gap-4">
              {/* BRAND INFO CARD */}
              <div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex sm:gap-4 xs:gap-2 gap-1">
              ...
              <div className="flex-1 flex gap-2 justify-between flex-wrap font-poppins">
                <div className="bg-white p-4 px-2 rounded-md flex gap-2 w-full md:w-[48%] xl:w-[49%] 2xl:w-[48%] cursor-pointer hover:bg-slate-100">
                ...
                <div className="bg-white p-4 rounded-md flex gap-2 w-full md:w-[48%] xl:w-[48%] 2xl:w-[48%] px-1 cursor-pointer hover:bg-slate-100">
                ...
                <div className="bg-white p-4 rounded-md flex gap-2 w-full md:w-[48%] xl:w-[48%] 2xl:w-[48%] cursor-pointer hover:bg-slate-100">
                ...
                <div className="bg-white p-4 rounded-md flex gap-2 w-full md:w-[48%] xl:w-[49%] 2xl:w-[48%] cursor-pointer hover:bg-slate-100">
