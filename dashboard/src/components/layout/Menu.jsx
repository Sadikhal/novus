...
const Menu = ({ open }) => {
  ...
  return (
    <div className={cn("fixed h-[calc(100vh-64px)] lg:top-1 top-16 left-0 lg:w-44", open ? "w-full" : "w-12 md:w-16")}>
          ...
          <div className="flex flex-col gap-2 px-3" key={section.title}>
            ...
            {section.items.map((item, index) => (
              item.href === "logout" ? (
                ...
                >
                  <img src={item.icon} alt="" className="min-h-5 h-5 min-w-5 w-5" />
