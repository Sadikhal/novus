    ...
    if (active && payload && payload.length) {
      ...
      return (
        <div className="bg-white p-4 rounded-lg shadow-xl border border-gray-200">
          <div className="font-bold text-center text-lg mb-2 text-teal-700">
          ...
          <div className="grid gap-2">
            ...
            <p className="text-sm bg-teal-50 p-2 rounded">
              <span className="font-semibold">Units Sold:</span> {data.totalSold}
            </p>
          </div>
        </div>
      );
      ...
      case 'area':
        return (
          <AreaChart {...chartProps}>
            ...
            <Legend 
              formatter={(value) => <span className="text-gray-600">{value === "totalRevenue" ? "Revenue" : "Units Sold"}</span>}
              iconType="circle"
            />
            <Area
              type="monotone"
