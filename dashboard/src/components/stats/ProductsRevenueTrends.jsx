    ...
    <div className="bg-white rounded-xl p-4 h-full flex flex-col shadow-sm">
      <div className="flex flex-wrap justify-between items-center gap-4 mb-6">
        ...
        <div className="flex flex-wrap gap-3 items-center">
          ...
          >
            <SelectTrigger className="border-gray-200 rounded-lg px-2 py-2 text-sm bg-white shadow-sm min-w-44 text-nowrap flex flex-nowrap items-center gap-1 ">
          ...
          >
            <SelectTrigger 
              className="border-gray-200 rounded-lg px-2 py-2 text-sm bg-white shadow-sm min-w-44 text-nowrap flex flex-nowrap items-center gap-1"
