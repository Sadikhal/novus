...
//   return (
//     <motion.div className='w-full flex flex-col gap-3 px-2 sm:px-3 md:px-5 lg:px-6 h-full'
...
//               <motion.span className='font-bold text-[0.875rem] leading-[1.40rem] tracking-wider text-[#0f4b53] capitalize font-robotos'
      ...
      <div className="carousel carousel-horizontal flex flex-row gap-6 justify-between h-full py-2 px-1">
        {categories?.map((category) => (
          ...
          >
            ...
            <div className='relative'>
              <motion.span
                className='font-bold text-[0.875rem] leading-[1.40rem] tracking-wider text-[#0f4b53] capitalize font-robotos'
                variants={textVariants}
              >
                {category?.name}
              </motion.span>
