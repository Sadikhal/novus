    ...
    <div className="w-full h-auto md:h-[500px] lg:[600px] xl:h-[400px] flex flex-col sm:flex-row gap-3">
        ...
        <div className="fixed inset-0 z-50 bg-black/80 flex justify-between w-full">
          ...
          <div className="flex-10 relative flex items-center justify-center w-full md:px-8">
            <img 
              ...
              className="md:w-[90%] w-full aspect-video h-[90%] border-4 rounded-md border-slate-300" 
              alt="Enlarged view" 
            />
            <div 
          ...
          >
            <img 
              src="/icons/arrow.png" 
              className="md:w-6 w-5 rotate-180" 
              alt="Next" 
            />
          </div>
        </div>
      ...
      <div className="flex-3 w-full sm:w-[90%] xl:w-[85%]">
        <img 
          ...
          className="aspect-video min-w-full min-h-[300px] md:min-h-[400px] h-full xl:min-h-[420px] cursor-pointer lg:min-h-[450px]"
