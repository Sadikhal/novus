...
//             <Button className='bg-transparent data-[hover]:bg-white/3 hover:bg-transparent w-full px-12 uppercase text-[#1a1b1b] text-[18px] font-[700] tracking-wide font-assistant border-none cursor-pointer'>about the brand</Button>
//           </Tab>
//           <Tab className="w-full rounded-sm py-1 px-3 text-sm/6 font-semibold text-white focus:outline-none data-[selected]:bg-[#ffffff] data-[hover]:bg-white/3 data-[selected]:data-[hover]:bg-white/10 data-[focus]:outline-1 data-[focus]:outline-white shadow-[#305a4e] shadow-sm data-[selected]:border-b-[3px] cursor-pointer transition ease-in-out duration-75 border-b-[#1e7e98]">
//             <Button className='bg-transparent data-[hover]:bg-white/3 hover:bg-transparent w-full px-12 uppercase text-[#1a1b1b] text-[18px] font-[700] tracking-wide font-assistant border-none cursor-pointer'>Reviews</Button>
//           </Tab>
//           <Tab className="w-full rounded-sm py-1 px-3 text-sm/6 font-semibold text-white focus:outline-none data-[selected]:bg-[#ffffff] data-[hover]:bg-white/3 data-[selected]:data-[hover]:bg-white/10 data-[focus]:outline-1 data-[focus]:outline-white shadow-[#305a4e] shadow-sm data-[selected]:border-b-[3px] cursor-pointer transition ease-in-out duration-75 border-b-[#1e7e98]">
//             <Button className='bg-transparent data-[hover]:bg-white/3 hover:bg-transparent w-full px-12 uppercase text-[#1a1b1b] text-[18px] font-[700] tracking-wide cursor-pointer font-assistant border-none'>Shipping and returns</Button>
//           </Tab>
//         </TabList>
...
//                     </li>
//                   </div>  
//                   <div className='text-[#111111] text-[16px] font-[300] font-helvetica  tracking-wide pt-5'>For any queries, please contact Customer Service at chat section or via customercareindia@puma.com</div>
//                   <div className='pt-12'>   
//                     <button onClick={handleMessageSubmit} className='btn hover:glass px-16 border-2 border-[#208328] hover:bg-[#206883] hover:text-lamaWhite hover:border-none uppercase text-[18px] bg-[#ffff] font-[700] tracking-wide font-assistant  text-[#208328]'>chat to seller</button>
//                   </div>  
//                 </div>
//               </div>
//             </div>
                ...
                <div className="text-left">
                  ...
                  <div className="pt-12">
                    <button
                      ...
                      className="btn hover:glass px-16 border-2 border-[#208328] hover:bg-[#206883] hover:text-lamaWhite hover:border-none uppercase text-[18px] bg-[#ffff] font-[700] tracking-wide font-assistant text-[#208328]"
                    >
                      chat to seller
                    </button>
                  </div>
